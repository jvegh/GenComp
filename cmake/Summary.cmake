...
function(caffe_status text)
  ...
  foreach(arg ${ARGN})
    ...
    elseif(arg STREQUAL "ELSE")
      set(status_current_name "else" set(CMAKE_CXX_STANDARD_REQUIRED ON)
)
    else()
...
#  message (STATUS "Settings to build SystemC ${SystemCLanguage_VERSION} (${SystemCLanguage_VERSION_RELEASE_DATE}) and TLM ${SystemCTLM_VERSION} (${SystemCTLM_VERSION_RELEASE_DATE})")
  ...
  caffe_status("  Git               :   ${GIT_VERSION}")
  caffe_status("  System            :   ${CMAKE_SYSTEM_NAME}-${CPACK_DEBIAN_PACKAGCMAKE_BUILD_TYPEE_ARCHITECTURE}")
  caffe_status("  C++ compiler      :   ${CMAKE_CXX_COMPILER}")
  caffe_status("  C++ standard is   :   ${CMAKE_CXX_STANDARD}")
  if(DEBUG_MODE)
...
#  caffe_status("")
  ...
  caffe_status("  SystemC           :   ${SystemCLanguage_VERSION}")
#  if(NEED_GUI)
    caffe_status("  Qt                :   ${QTGUI_VERSION_STR}")
#  endif(NEED_GUI)
  ...
  IF(BUILD_TESTS)
    caffe_status("  GoogleTest        : " GTEST_FOUND THEN "${GTEST_LIBRARIES} (${GTEST_VERSION})" ELSE "No")
  endif(BUILD_TESTS)
  if(BUILD_DOCS)
 ...
 #      caffe_status("  config_file       :   /home/jvegh/SystemC/GenComp/doc/Doxyfile_in")
      if(UNIX)
        FIND_PROGRAM(DPKG_CHMCMD_FOUND chmcmd)
        if(DPKG_CHMCMD_FOUND)
            caffe_status("  chmcmd            :" DPKG_CHMCMD_FOUND THEN "Yes" ELSE "No")
          FIND_PROGRAM(CHM2PDF_FOUND chm2pdf)
          if(CHM2PDF_FOUND)
              caffe_status("  chm2pdf           :" CHM2PDF_FOUND THEN "Yes" ELSE "No")
          endif(CHM2PDF_FOUND)
        endif(DPKG_CHMCMD_FOUND)
        FIND_PROGRAM(PDFLATEX_FOUND pdflatex)
        if(PDFLATEX_FOUND)
            caffe_status("  pdflatex          :" PDFLATEX_FOUND THEN "Yes" ELSE "No")
