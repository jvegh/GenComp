...
/// Adds GenComp CLI options to a parser.
void addCLIOptions(QCommandLineParser &parser, GenComp::CLIModeOptions &options);

/// Parses GenComp CLI mode options to a CLIModeOptions struct. Returns
